    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('dashboard') }}" class="d-lg-none">
                <span class="h-15px">
                    <span style="font-size: 25px; color: #fd7d18" class="fw-bolder">AVIATOR</span> <span
                        style="font-size: 25px; color: #3ad706;" class="fw-bolder">SIGNALS</span>
                </span>
                {{-- <img alt="Logo" src="{{ asset('assets/media/images/logo.png') }}" class="h-45px" /> --}}
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                ...
                <div class="header-menu align-items-stretch" data-kt-drawer="true" data-kt-drawer-name="header-menu"
                    ...
                    <div class="menu menu-rounded menu-column menu-lg-row menu-root-here-bg-desktop menu-active-bg menu-state-primary menu-title-gray-800 menu-arrow-gray-400 align-items-stretch my-5 my-lg-0 px-2 px-lg-0 fw-semibold fs-6"
                        ...
                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                            ...
                            <!--begin:Menu link-->
                            <span class="py-3">
                                <span class="menu-title text-danger">AVIATOR SIGNALS</span>
                            </span>
                            <!--end:Menu link-->
                        </div>
                    </div>
            ...
            <div class="topbar d-flex align-items-stretch flex-shrink-0">
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    <h1 id="header-clock" class="d-flex align-items-center text-white fw-bold my-1 fs-5"></h1>
                    <span class="h-20px border-gray-200 border-start mx-4"></span>
                </div>
                <div class="d-flex align-items-center ms-1 ms-lg-3">
                    <!--begin::Menu wrapper-->
                    <div class="btn btn-icon position-relative btn btn-icon w-30px h-30px w-md-40px h-md-40px pulse pulse-success text-white"
                        id="kt_drawer_chat_toggle">

                        <i class="bi bi-app-indicator fs-2">120</i>
                        <span class="pulse-ring w-45px h-45px text-white"></span>
                        <span>Online</span>
                ...
                <div class="d-flex align-items-center">
                    <!--begin::Menu toggle-->
                    <a href="#" class="topbar-item px-3 px-lg-5"
                ...
                <div class="d-flex align-items-stretch" id="kt_header_user_menu_toggle">
                    ...
                    <div class="topbar-item cursor-pointer symbol px-3 px-lg-5 me-n3 me-lg-n5 symbol-30px symbol-md-35px"
                        ...
                        <img src="{{ asset('assets/media/images/blank.svg') }}" alt="metronic" />
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="{{ asset('assets/media/images/blank.svg') }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5">
                                        <span
                                            class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ Auth::user()->name }}</span>
                                    </div>
                                    <a href="#"
                        ...
                        <div class="menu-item px-5 my-1">
                            <a href="{{ route('profile.edit') }}" class="menu-link px-5">Edit Profile</a>
                        </div>
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a onclick="event.preventDefault(); document.forms['logout-form'].submit()"class="menu-link px-5" style="cursor:pointer">Logout</a>
